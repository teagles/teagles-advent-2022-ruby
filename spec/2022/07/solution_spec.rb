...
RSpec.describe Year2022::Day07 do
  ...
  describe 'part 1' do
    ...
    it 'returns 1444896 for my input' do
      expect(described_class.part_1(input)).to eq(1_444_896)
    end
  end
  ...
  describe 'part 2' do
    ...
    it 'returns 404395 for my input' do
      expect(described_class.part_2(input)).to eq(404_395)
    end
  end
end
