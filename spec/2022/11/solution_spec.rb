...
RSpec.describe Year2022::Day11 do
  ...
  describe 'part 1' do
    ...
    it 'returns 76728 for my input' do
      expect(described_class.part_1(input)).to eq(76_728)
    end
  end
  ...
  describe 'part 2' do
    ...
    it 'returns 21553910156 for my input' do
      expect(described_class.part_2(input)).to eq(21_553_910_156)
    end
  end
end
