...
RSpec.describe Year2022::Day12 do
  ...
  describe 'part 1' do
    ...
    it 'returns 394 for my input' do
      expect(described_class.part_1(input)).to eq(394)
    end
  end
  ...
  describe 'part 2' do
    ...
    it 'returns 388 for my input' do
      expect(described_class.part_2(input)).to eq(388)
    end
  end
end
